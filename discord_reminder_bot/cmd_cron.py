...
@lightbulb.command(
    name="cron",
    description="Triggers when current time matches all specified time constraints, similarly to the UNIX cron.",  # noqa: E501
)
@lightbulb.implements(lightbulb.SlashSubCommand)
async def command_cron(ctx: lightbulb.SlashContext) -> None:
    """Triggers when current time matches all specified time constraints, similarly to the UNIX cron."""  # noqa: E501
